...
- If eyes need to be swapped
  ...
  - Use <a href="https://helixmod.blogspot.com/2015/10/advanced-3d-vision-configuration.html" target="_blank" rel="noopener noreferrer">Advanced 3DVision Configuration</a> (run as admin) to set `Swap Interleave Pattern` and `Lock Registry Key`
